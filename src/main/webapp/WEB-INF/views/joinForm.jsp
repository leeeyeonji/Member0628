...
<!-- 					<p id=idcheck flag=false></p> -->
				...
				<tr>
					...
					<td colspan="1">
                     <input type="password" id=pw
						...
						required name=pw class=box>
                    <td colspan="1" id=result1></td>
				</tr>
				<tr>
					<td>비밀번호 확인 :
					<td colspan="1">
					<input type="password" id=pwCheck name=pwCheck class=box flag=false>
					<td colspan="1" id=result2></td>
				</tr>
				<tr>
					<td>이름 :
					<td colspan="2">
					<input type="text" required id=name name=name class=box>
				</tr>
				<tr>
					<td>프로필사진 :</td>
				...
				<tr>
					<td>전화번호 :
					<td colspan="2">
					<input type="text" placeholder="-를 포함하여 띄어쓰기 없이 입력" id=phone name=phone class=box>
				...
				<tr>
					<td>우편번호 :
					<td colspan="2">
					<input type="text" id=zipcode name=zipcode readonly placeholder="찾기 버튼을 눌러 주소 입력" class=box>
						<button id=zipBtn type=button>찾기</button>
				</tr>
				<tr>
					<td>주소1 :
					<td colspan="2">
					<input type="text" id=address1 readonly name=addr1 class=box>
				</tr>
				<tr>
					<td>주소2 :
					<td colspan="2">
					<input type="text" id=address2 name=addr2 class=box>
				</tr>
				<tr id=btn>
					<td colspan="3">
...
// 		alert(form);
		$.ajax({
			...
			console.log(resp)
			$("#img").html("<img src=/image/"+resp+" width=100px>")
			$("#image").val(resp);		
		})
		})
